...
import './Tic.css'
import circle from '../Assets/img3.jpg'
import img2 from '../Assets/img6.jpg'
// import img2 from '@/Components/Assets/img6.jpg'
...
const Tic = () => {
  ...
  const won = (winner) => {
    setLock(true)
    if(winner === 'x'){
        titleRef.current.innerHTML = 'Conraturlation: <span>x</span> Wins'
    }
    else
    {
      titleRef.current.innerHTML = 'Conraturlation: <span>o</span> Wins'
    }
  }
  const reset = () => {
    setLock(false)
...
export default Tic
  ...
  //     setLock(true)
  //     if( winner === 'x'){
  //       titleRef.current.innerHTML = 'Congratulation: <span>X</span> Wins'
  //     }
  //     else
  //     {
  //       titleRef.current.innerHTML = 'Congratulation: <span>o</span> Wins'
  //     }
  //   }
